        ...
        <div class="block-content">
            ...
            @csrf
                ...
                <div class="input-group-append" style="float:right;">
                    <button type="submit" class="btn btn-hero-primary">Add</button>
                </div>
                </h2>
                <div class="row push">
                    <div class="col-lg-8" style="padding-left: 50px;">                      
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control input" placeholder="" name="correction_name" required>
                        </div>                                              
                    </div> 
                    <div class="col-lg-8" style="padding-left: 50px;">                      
                        <div class="form-group">
                            <label for="example-text-input">Type: (should type Lift or Escalator)</label>
                            <input type="text" class="form-control input" placeholder="" name="type" required>
                        </div>                                              
                    </div>                               
                </div>                  
            </form>
