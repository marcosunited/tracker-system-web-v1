...
<div class="content">
    <div class="block block-rounded block-bordered">
        ...
        <span class="badge badge-pill badge-success">View:</span>&nbsp&nbsp<h3 class="block-title">{{$correction->correction_name}}</h3>
        </div>
        <div class="block-content">
            <form action="/correction/{{$correction->id}}" method="POST">
            @csrf
                ...
                <div class="row push">
                    <div class="col-lg-8" style="padding-left: 50px;">                      
                        <div class="form-group">
                            <label for="example-text-input">Correction Name</label>
                            <input type="text" class="form-control input" placeholder="" name="correction_name" required value="{{$correction->correction_name}}">
                        </div>                                              
                    </div> 
                    <div class="col-lg-8" style="padding-left: 50px;">                      
                        <div class="form-group">
                            <label for="example-text-input">Type: (should type Lift or Escalator)</label>
                            <input type="text" class="form-control input" placeholder="" name="type" required value="{{$correction->type}}">
                        </div>                                              
                    </div>                               
                </div>                  
            </form>
