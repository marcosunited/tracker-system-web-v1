...
<div class="content">
    ...
    <div class="block">
        <div class="block-header block-header-default">
            <h3 class="block-title">Notes for Repair ID {{$repair->id}} {{$repair->jobs->job_name}}</h3>
            <div class="block-options">
                <button type="button" class="btn btn-hero-primary" data-toggle="modal" data-target="#repair_notes">Add
                    Notes</button>
            </div>
        </div>
            ...
            <div class="col-md-6">
                <div class="block block-themed">
                    <div class="block-header">
                        ...
                        <div class="block-options">
                            <form method="POST" action="/repairs/{{$repair->id}}/notes/{{$note->id}}">
                                @method('DELETE')
                                @csrf
...
<div class="modal" id="repair_notes" tabindex="-1" role="dialog" aria-labelledby="repair_notes" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="block block-themed block-transparent mb-0">
                <div class="block-header bg-primary-dark">
                    <h3 class="block-title">Add Notes For {{$repair->jobs->job_name}}</h3>
                    <div class="block-options">
                ...
                <div class="block-content">
                    <form action="/repairs/{{$repair->id}}/notes" method="POST">
                        @csrf
