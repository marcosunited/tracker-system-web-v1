...
<div class="content">
    ...
    <div class="block block-rounded block-bordered">
        ...
        <div class="block-content block-content-full">
            <h2 class="content-heading">Job File Uploads</h2>
            <div class="row">
                <div class="col-lg-4">
                    <p class="text-muted">
                ...
                <div class="col-lg-8 col-xl-5">
                    ...
                    <form class="dropzone" action="/jobs/{{$job->id}}/file" id="my-awesome-dropzone" method="post"
    ...
    <div class="block block-rounded block-bordered">
        <div class="block-content block-content-full">
        <div class="block-header block-header-default">
            <h3 class="block-title">Files for {{$job->job_name}}</h3>
        </div>
            ...
            <table class="table table-bordered table-striped table-vcenter">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                        <form method="POST" action="/jobs/{{$job->id}}/file/{{$file->id}}">
                                @method('DELETE')
                                @csrf
