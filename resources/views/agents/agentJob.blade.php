...
<div class="bg-white inner-top-bar">
    ...
    <div class="bg-body-light">
            ...
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                <h1 class="flex-sm-fill font-size-h2" style="padding-left: 50px;">All {{$agent->agent_name}} Jobs Table</h1>
                ...
                <div class="block-content block-content-full aspect-ratio-1-1 d-flex justify-content-center align-items-center">
                    <div>
                        <div class="font-size-h1 font-w300 text-white">{{count($agent->jobs)}}</div>
