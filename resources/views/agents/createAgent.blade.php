...
<div class="content">
    ...
    <div class="block block-rounded block-bordered">
        <div class="block-header block-header-default">
            <span class="badge badge-pill badge-success">Add:</span>&nbsp&nbsp<h3 class="block-title">New Agent</h3>
        </div>
            ...
            <form action="/agents" method="POST">
                ...
                <h2 class="content-heading pt-0">Basic
                    <div class="input-group-append" style="float:right;">
                        <button type="submit" class="btn btn-hero-primary">Add Agent</button>
                    </div>
                </h2>
                <div class="col-lg-4" style="padding-left: 50px;">
                        ...
                        <div class="form-group">
                            <label for="example-text-input">Agent Phone</label>
                            <input type="text" class="form-control"  name="agent_phone" required>
                        </div>
                        <div class="form-group">
                            <label for="example-text-input">Agent Address</label>
                            <input type="text" class="form-control"  name="agent_address" required>
                        </div>
                        <div class="form-group">
                            <label for="example-text-input">Agent Fax</label>
                            <input type="text" class="form-control"  name="agent_fax" required>
                        </div>
                    </div>
                </div>
        </form>
