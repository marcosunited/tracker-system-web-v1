...
<style>
#callout_map{width:100%;height:300px}
</style>    
@endsection
                ...
                <div class="row">
                    ...
                    <div class='col-lg-8'>
                        <div class="row">
                            ...
                            <div class="input-group date" id="toa" data-target-input="nearest">
                                <input type="text" name="toa_date" class="form-control datetimepicker-input"
                                    data-target="#toa" value="{{$maintenance->maintenance_toa}}" />
                            ...
                            <div class="input-group date" id="tod" data-target-input="nearest">
                                <input type="text" name="tod_date" class="form-control datetimepicker-input"
                                    data-target="#tod" value="{{$maintenance->maintenance_tod}}" />
                            ...
                            <div class="col-md-6">
                            <div class="form-group">
                            <!-- <div class="input-group date" id="toa_new" data-target-input="nearest">
                                <input type="text" name="toa_new_date" class="form-control datetimepicker-input"
                                    data-target="#toa" value="{{$maintenance->toa}}" />
                                <div class="input-group-append" data-target="#toa" data-toggle="datetimepicker">
                                    <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                </div>
                            </div>
                            <div class="input-group date" id="tod_new" data-target-input="nearest">
                                <input type="text" name="tod_new_date" class="form-control datetimepicker-input"
                                    data-target="#tod" value="{{$maintenance->tod}}" />
                                <div class="input-group-append" data-target="#tod" data-toggle="datetimepicker">
                                    <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                </div>
                            </div> -->
                    ...
                    <div class="col-lg-12 col-xl-12">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="{{$maintenance->docket_no}}"
                                name="docket_no">
                        </div>

                        <div class="form-group">
                            <label for="example-text-input">Maintenance Note</label>
                            <textarea class="form-control" rows="3" placeholder="" name="maintenance_note" style="height: 115px;">{{$maintenance->maintenance_note}}</textarea>
                        </div>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="block block-rounded block-bordered">
                        <select id="active_month" name="active_month" class="form-control" disabled
                                            ...
                                            <tr>
                                                ...
                                                <div class="custom-control custom-checkbox custom-checkbox-square custom-control-lg custom-control-primary mb-1">
                                                    <input type="checkbox" class="custom-control-input checkitem1" id="example-cb-custom-square-lg{{$task->task_id}}"
                                                        name="task[]" value="{{$task->task_id}}" checked readonly>
