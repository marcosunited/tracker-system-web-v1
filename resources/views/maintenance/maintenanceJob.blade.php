...
<div class="content">
    ...
    <div class="block block-rounded block-bordered">
        <div class="block-header block-header-default">
            ...
            <a href="/jobs/{{$maintenance->jobs->id}}"><button style="float:right;" type="button" class="btn btn-hero-warning">Update on this link</button></a>
        </div>
        <div class="block-content">
            <div class="input-group-append" style="float:right;">
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <p class="text-muted">
                            Start Time and Finish time about this Job
                        </p>
                    </div>
                    ...
                    <div class="col-lg-4">
                        <p class="text-muted">
                            Cancellation Time about this Job
                        </p>
                    </div>
                    <div class="col-lg-8 col-xl-6">
                        <div class="form-group">
                ...
                <h2 class="content-heading pt-0">Finiance</h2>
                <div class="row push">
                    <div class="col-lg-4">
                        <p class="text-muted">
