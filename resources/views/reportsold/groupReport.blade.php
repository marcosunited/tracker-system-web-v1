...
<script>
    $(document).ready(function() { $(".group_select").select2(); });
 </script>
...
<div class="bg-white inner-top-bar">
    <div class="content">
        ...
        <!-- Main Navigation -->
        @include('layouts.innerReportNav')
        <!-- END Main Navigation -->
    </div>
</div>
<!-- Page Content -->
<div class="content">
    <div class="block block-rounded block-bordered">
        <div class="block-content">
            <form action="/reports/old/groupreport/generate" method="POST">
                @csrf
                <h2 class="content-heading pt-0">Group Report (Callouts + Maintenance)
                ...
                <div class="row push">
                    <div class="col-lg-4" style="padding-left: 50px;">
                        <div class="form-group">
                            ...
                            <select class="form-control group_select" name="job_group" required>

                                <option value="">--- Select Group ---</option>
                                @foreach ($group_list as $data)
                                <option value="{{ $data->job_group }}">{{ $data->job_group }}</option>
                                @endforeach
                            </select>
                        </div>
