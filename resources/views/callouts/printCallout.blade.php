        ...
        <div id="details" class="clearfix">
            ...
            <div id="invoice">
                ...
                <div class="date">Time of Arrival:
                    ...
                    {{date('d-m-Y H:i:s',strtotime($callout->time_of_arrival))}}
                    @else
                    {{date('d-m-Y H:i:s',strtotime($callouttime->toa))}}
                    @endif
                </div>
                <div class="date">Time of Departure:
                    @if($callouttime === NULL || $callouttime->tod === NULL)
                    {{date('d-m-Y H:i:s',strtotime($callout->time_of_departure))}}
                    @else
                    {{date('d-m-Y H:i:s',strtotime($callouttime->tod))}}
                    @endif
                </div>
            </div>
        </div>
