        ...
        <div id="details" class="clearfix">
            ...
            <div id="invoice">
                ...
                <div class="date">Time of Arrival:
                    <?php
                    $time_arrival_checked = $callouttime == null ? false : strtotime($callouttime->toa);
                    $time_arrival = $callout->time_of_arrival == null ? false : strtotime($callout->time_of_arrival);
                    ?>
                    {{ $time_arrival_checked ? date('d-m-Y H:i:s', $time_arrival_checked) : ($time_arrival ? date('d-m-Y H:i:s',$time_arrival) : 'Not defined') }}
                </div>
                <div class="date">Time of Departure:
                    <?php
                    $time_departure_checked = $callouttime == null ? false : strtotime($callouttime->tod);
                    $time_departure = $callout->time_of_departure == null ? false : strtotime($callout->time_of_departure);
                    ?>
                    {{ $time_departure_checked ? date('d-m-Y H:i:s', $time_departure_checked) : ($time_departure ? date('d-m-Y H:i:s',$time_departure) : 'Not defined') }}
                </div>
            </div>
        </div>
        <table>
